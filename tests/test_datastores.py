...
class InMemoryTests(unittest.TestCase):
    ...
    def test_list_single_set(self):
        ...
        # registra a view no datastore
        self.store.views['set1'] = set1_view
        ...
        set1_factories = list(self.store.list(view='set1'))
    ...
    def test_partial_list(self):
        ...
        set1_factories = list(self.store.list(view='set1', count=10))
    ...
    def test_offset_list(self):
        ...
        set2_factories = list(self.store.list(view='set1',
            offset=0, count=20))
